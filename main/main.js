...
.controller('mainController', ['$scope','$routeParams', 'SummonerService', 'Main', function($scope,$routeParams,SummonerService,Main){
		...
		Main.setUpChampions().then(function(success){
			$scope.adc={levelZero: {title: 1, desc:$scope.desc[0],champs:success.adc},LevelOne: {title:2, desc:$scope.desc[1], champs:[]},LevelTwo: {title:3, desc:'', champs:[]},LevelThree: {title:4, desc:'', champs:[]},LevelFour: {title:5, desc:'', champs:[]},LevelFive: {title:6, desc:'', champs:[]},LevelSix: {title:7, desc:'', champs:[]},LevelSeven: {title:8, desc:'', champs:[]},LevelEight: {title:9, desc:'', champs:[]},LevelNine: {title:10, desc:'', champs:[]},LevelTen: {title:11, desc:'', champs:[]},LevelEleven: {title:12, desc:'', champs:[]},LevelTwelve: {title:13, desc:'', champs:[]},LevelThirteen: {title:14, desc:'', champs:[]}};
			$scope.mid={levelZero: {title: 1, desc:$scope.desc[0],champs:success.mid},LevelOne: {title:2, desc:$scope.desc[1], champs:[]},LevelTwo: {title:3, desc:'', champs:[]},LevelThree: {title:4, desc:'', champs:[]},LevelFour: {title:5, desc:'', champs:[]},LevelFive: {title:6, desc:'', champs:[]},LevelSix: {title:7, desc:'', champs:[]},LevelSeven: {title:8, desc:'', champs:[]},LevelEight: {title:9, desc:'', champs:[]},LevelNine: {title:10, desc:'', champs:[]},LevelTen: {title:11, desc:'', champs:[]},LevelEleven: {title:12, desc:'', champs:[]},LevelTwelve: {title:13, desc:'', champs:[]},LevelThirteen: {title:14, desc:'', champs:[]}};
			$scope.top={levelZero: {title: 1, desc:$scope.desc[0],champs:success.top},LevelOne: {title:2, desc:$scope.desc[1], champs:[]},LevelTwo: {title:3, desc:'', champs:[]},LevelThree: {title:4, desc:'', champs:[]},LevelFour: {title:5, desc:'', champs:[]},LevelFive: {title:6, desc:'', champs:[]},LevelSix: {title:7, desc:'', champs:[]},LevelSeven: {title:8, desc:'', champs:[]},LevelEight: {title:9, desc:'', champs:[]},LevelNine: {title:10, desc:'', champs:[]},LevelTen: {title:11, desc:'', champs:[]},LevelEleven: {title:12, desc:'', champs:[]},LevelTwelve: {title:13, desc:'', champs:[]},LevelThirteen: {title:14, desc:'', champs:[]}};
		});
}])